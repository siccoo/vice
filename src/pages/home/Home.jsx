...
const Home = () => {
  ...
  return (
    <div className="payvice__container">
      <div className="payvice__content__wrap">
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-12 text-center">
                    <h3>
                      Become a ITEX <span>PayVice agent</span> and earn more
                    </h3>
                    <div>
                      <img
                        src={PayviceRec}
                    ...
                    <p>
                      ...
                      Nigeria alone and over 15,000 deployed across Africa. We
                      are licensed by the Central Bank of Nigeria and we are all
                      about implementation of a “Cashless Nigeria”. Ready to
                      become an agent?
                    </p>
                  </div>
                </div>
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <form>
                      <p>
                        Please enter your details below and our support team
